...
public class Client implements ActionListener{
    ...
    Client()// Constructor is called immediately after the object is created 
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icon/bg_1.png"));// adding my profile image
        ...
        JLabel name = new JLabel("Prajwal");// adding text to the frame
    ...
    public static void main(String args[]){
        new Client();// anonmous object creation because after creatin this object the server constructor gets called.
